...
public class KarateUtils {
    public static void modificarArchivo() {
        String csvFile = "src/test/java/acceptance/test/recaudoTemplateDatosCorrectos.csv";
        String line = "";
        String cvsSplitBy = ","; // El delimitador de tu CSV, usualmente es una coma
        List<String> lines = new ArrayList<>();
        String docNumberToSearch = "461346"; // Aquí puedes poner el número de documento que estás buscando
